...
public class ControlFlow {
	...
	private static void iteration() {
		...
		System.out.println("\nLoop 2:");
		for (int x = getInitialValue(), i = x == -2 ? x + 2 : 0, j = 0; i < 3 || j < 3; ++i, j = i) {
			System.out.println(i + " " + j); // prints: 0 0
												// 1 1
												// 2 2
		}
	...
	private static void branching() {
		...
		// String found = null;
		List<List<String>> listOfLists = List.of(List.of("24", "16", "1", "2", "1"),
				List.of("43", "42", "31", "3", "3"), List.of("24", "22", "31", "2", "1"));
		...
		System.out.println("\nContinue statements:");
		/*
		 * String found = null; List<List<String>> listOfLists = List.of( List.of("24",
		 * "16", "1", "2", "1"), List.of("43", "42", "31", "3", "3"), List.of("24",
		 * "22", "31", "2", "1") );
		 */
		String checked = "";
		...
		int result = 0;
		List<List<Integer>> source = List.of(List.of(1, 2, 3, 4, 6), List.of(22, 23, 24, 25), List.of(32, 33));
