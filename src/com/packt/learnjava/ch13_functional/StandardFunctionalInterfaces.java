...
public class StandardFunctionalInterfaces {
	...
	private static void consumer() {
		...
		Consumer<Person> setRecord = p -> p
				.setRecord(p.getFirstName() + " " + p.getLastName() + ", " + p.getAge() + ", " + externalData);
	...
	private static void predicate() {
		...
		int val = 7;
		Consumer<String> printIsSmallerThan10 = printWithPrefixAndPostfix("Is " + val + " smaller than 10? ",
				" Great!");
		printIsSmallerThan10.accept(String.valueOf(isLessThan10.test(val))); // prints: Is 7 smaller than 10? true
																				// Great!
	...
	private static void supplier() {
		...
		Consumer<String> printResult = printWithPrefixAndPostfix("Is " + input + " smaller than " + limit + "? ",
				" Great!");
